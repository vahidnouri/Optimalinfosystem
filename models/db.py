...
#  نمونه خون
    ...
    Field("cvs_1", requires=IS_IN_SET(yes_no, zero=None),label="CVS",required = True), 
    Field("af_1", requires=IS_IN_SET(yes_no, zero=None),label="AF",required = True), 
    Field("abortion_product_1", requires=IS_IN_SET(yes_no, zero=None),label="محصول سقط",required = True), 
    Field("cortage_product_1", requires=IS_IN_SET(yes_no, zero=None),label="محصول کورتاژ",required = True), 
    Field("paraffin_texture_1", requires=IS_IN_SET(yes_no, zero=None),label="بافت پارافینه",required = True), 
    Field("blood_others_1", "string",label="سایر",required = True), 
